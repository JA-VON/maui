	...
	public static void runMaui(String[] options) throws Exception {
        ...
        try {
            ...
            for (Topic keyword : keywords) {
				...
				topicObject.put("title", keyword.getTitle());
				topicObject.put("id", keyword.getId());
				topicObject.put("probability", keyword.getProbability());
				topicObject.put("correct", keyword.isCorrect());
			...
			System.out.println(resultsObject.toJSONString());
